...
class Individual:
    ...
    def remove_player_and_add_new_player(self, kick_player, new_player):
        ...
        self.sameTeam[kick_player.team] += 1
        self.code.remove(kick_player)
        self.code.append(new_player)
        self.sameTeam[new_player.team] -= 1
    ...
    def correct_non_feasible(self):
        ...
        while any(x is False for x in all_conditions):
            ...
            while any(x < 0 for x in self.sameTeam):
                all_conditions[1] = False
                team_index = next(x for x, val in enumerate(self.sameTeam) if val < 0)
...
def mutation(individual):
    ...
    for i in range(length):
        ...
        while True:
            ...
            individual.sameTeam[kick_player.team] += 1
            individual.code.remove(kick_player)
            individual.code.append(new_player)
            individual.sameTeam[new_player.team] -= 1
...
async def main():
    ...
    gks, dfs, mfs, fws = init(players_sorted)
